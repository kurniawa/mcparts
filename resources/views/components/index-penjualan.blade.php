            ...
            <div>
                ...
                <table class="table-nice mt-1">
                    ...
                    <tr class="{{ $nota_subtotal['class'] }}">
                        <td><a href="{{ route('spks.show', $nota_subtotal['spk_id']) }}" class="font-bold text-sky-400">{{ $nota_subtotal['nomor_nota'] }}</a></td><td>{{ date('d-m-Y', strtotime($nota_subtotal['created_at'])) }}</td>
            ...
            <div class="mt-2">
                ...
                <table class="table-nice mt-1">
                    ...
                    <tr class="{{ $nota_detail_item['class'] }}">
                        <td>{{ date('d-m-Y', strtotime($nota_detail_item['created_at'])) }}</td><td><a href="{{ route('spks.show', $nota_detail_item['spk_id']) }}" class="font-bold text-sky-400">{{ $nota_detail_item['nomor_nota'] }}</a></td>
