            ...
            <table class="text-xs table-border w-3/4 max-w-full">
                <tr>
                    ...
                    <th>
                        <div class="flex justify-between bg-yellow-300">
                            <span>Rp</span>
                            <span>{{ number_format(($masuk_total - $keluar_total),2,',','.') }}</span>
                            <span> ,-</span>
                        </div>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-between">
                            <span>Rp</span>
                            <span>{{ number_format($kategori_level_two['jumlah'],2,',','.') }}</span>
                            <span> ,-</span>
                        </div>
                    </td>
                    @elseif ($ringkasan['type'] === 'UANG KELUAR')
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-between">
                            <span>Rp</span>
                            <span>{{ number_format($kategori_level_one['jumlah'],2,',','.') }}</span>
                            <span> ,-</span>
                        </div>
                    </td>
                    @elseif ($ringkasan['type'] === 'UANG KELUAR')
        ...
        <div class="mt-2">
            <table id="table-ringkasan" class="hidden">
                ...
                <tr>
                    ...
                    @if ($ringkasan['type'] === 'UANG MASUK')
                    <td></td>
                    <td>{{ (float)($kategori_level_two['jumlah']) }}</td>
                    @elseif ($ringkasan['type'] === 'UANG KELUAR')
                    <td>{{ (float)($kategori_level_two['jumlah']) }}</td>
                    @endif
                </tr>
                ...
                <tr>
                    ...
                    @if ($ringkasan['type'] === 'UANG MASUK')
                    <td></td>
                    <td>{{ (float)($kategori_level_one['jumlah']) }}</td>
                    @elseif ($ringkasan['type'] === 'UANG KELUAR')
                    <td>{{ (float)($kategori_level_one['jumlah']) }}</td>
                    @endif
                </tr>
