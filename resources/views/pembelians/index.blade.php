...
<main>
    ...
    {{-- SEARCH / FILTER --}}
    <div class="relative border rounded mt-9">
        <div class="flex absolute -top-7 left-1/2 -translate-x-1/2">
            @if ($route_now === 'pembelians.index')
            <div class="border-t-4 border-x rounded-t bg-white pt-1 px-1 font-bold">Pembelian</div>
            @else
            <a href="{{ route('pembelians.index') }}" class="border-t border-x rounded-t bg-white pt-1 px-1">Pembelian</a>
            @endif
            <div class="border-t border-x rounded-t bg-white pt-1 px-1 ml-2">Barang</div>
            <div class="border-t border-x rounded-t bg-white pt-1 px-1 ml-2">Supplier</div>
        </div>
