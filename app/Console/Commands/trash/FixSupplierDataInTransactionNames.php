...
class FixSupplierDataInTransactionNames extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'transaction_names:fix-supplier-data';
    ...
    {
        $transactionNames = \App\Models\TransactionName::where('kategori_level_one', 'BAYAR HUTANG BAHAN BAKU')->get();
