            ...
            <div>
                ...
                <div class="border-t-4 pt-2">
                    ...
                    <div class="flex justify-end mt-1 mb-2 items-center gap-1">
                        @if ($user->role == 'superadmin' || $user->role == 'developer' || $user->role == 'admin')
                            <form action="{{ route('notas.hide', $nota->id) }}" method="POST">
                                @csrf
                                @if ($nota->copy)
                                    <button type="submit" name="hide" value="yes" class="text-slate-500">
                                ...
                                @else
                                    <button type="submit" name="hide" value="no" class="text-slate-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-5 h-5">
